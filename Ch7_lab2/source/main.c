...
int main(void)
{
	...
	err_pRead = fopen_s(&pRead, "C://Users/User/Desktop/credit.txt", "r");
	if (err_pRead != 0) return 0;

	err_pWrite = fopen_s(&pWrite, "C://Users/User/Desktop/credit_bin.txt", "wb");
	if (err_pWrite != 0)
	{
		fclose(pRead);
		return 0;
	...
	printf("\n讀取二進制資料檔案，並格式化輸出如下：\n");
	err_cfPtr = fopen_s(&cfPtr, "C://Users/User/Desktop/Lab7-2/credit_bin.txt", "rb");
